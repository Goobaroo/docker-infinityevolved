...
The docker on first run will download the same version as tagged of FTB Infinity Evolved 1.7 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Infinity Evolved 1.7 Server Powered by Docker"
* LEVEL 
...
## Source
Github: https://github.com/Goobaroo/docker-infinityevolved

Docker: https://hub.docker.com/repository/docker/goobaroo/infinityevolved